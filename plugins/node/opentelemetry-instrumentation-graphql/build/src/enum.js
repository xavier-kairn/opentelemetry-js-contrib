...
exports.SpanNames = exports.SpanAttributes = exports.TokenKind = exports.AllowedOperationTypes = void 0;
...
(function (SpanAttributes) {
    SpanAttributes["COMPONENT"] = "graphql";
    SpanAttributes["SOURCE"] = "graphql.source";
    SpanAttributes["FIELD_NAME"] = "graphql.field.name";
    SpanAttributes["FIELD_PATH"] = "graphql.field.path";
    SpanAttributes["FIELD_TYPE"] = "graphql.field.type";
    SpanAttributes["OPERATION"] = "graphql.operation.name";
    SpanAttributes["VARIABLES"] = "graphql.variables.";
    SpanAttributes["ERROR_VALIDATION_NAME"] = "graphql.validation.error";
})(SpanAttributes = exports.SpanAttributes || (exports.SpanAttributes = {}));
var SpanNames;
(function (SpanNames) {
